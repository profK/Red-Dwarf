...
public final class ChannelServiceImpl
    extends AbstractService implements ChannelManager, ProfileProducer
{
    ...
    /**
     * Records a list of the number of operations in the channel event queue.
     */
    ProfileSample channelQueueLength = null;

    /* -- Channel operations -- */

    ProfileOperation createChannelOp = null;
    ProfileOperation joinChannelOp = null;
    ProfileOperation leaveChannelOp = null;
    ProfileOperation leaveAllChannelsOp = null;
    ProfileOperation sendChannelOp = null;
    ProfileOperation sendChannelRejectedOp = null;
    ProfileOperation closeChannelOp = null;
	...
	try {
	    if (createChannelOp != null) {
		createChannelOp.report();
	    }
	    Channel channel =
    ...
    public void setProfileRegistrar(ProfileRegistrar profileRegistrar) {
        ...
        if (consumer != null) {
            channelQueueLength = consumer.registerSampleSource(
		"channelQueueLength", true, Integer.MAX_VALUE);
	    createChannelOp = consumer.registerOperation("createChannel");
	    joinChannelOp = consumer.registerOperation("joinChannel");
	    leaveChannelOp = consumer.registerOperation("leaveChannel");
	    leaveAllChannelsOp = consumer.registerOperation("leaveAllChannels");
	    sendChannelOp = consumer.registerOperation("sendChannel");
	    sendChannelRejectedOp = consumer.registerOperation(
		"sendChannelRejected");
	    closeChannelOp = consumer.registerOperation("closeChannel");
        }
    }
