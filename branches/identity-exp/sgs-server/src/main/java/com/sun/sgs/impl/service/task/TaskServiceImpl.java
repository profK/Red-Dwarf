...
import com.sun.sgs.app.annotation.NewIdentity;
        ...
        implements TaskService, NodeMappingListener, RecoveryListener 
{
    ...
    /** Private method to get or create an owner for the task. */
    private Identity getTaskOwner(Object task) {
        if (task.getClass().getAnnotation(NewIdentity.class) != null) {
    ...
    /** Private implementation of identity. */
    private static class DynamicIdentity implements Identity, Serializable {
        ...
        /** This identity will never log in. */
        public void notifyLoggedIn() {
            throw new AssertionError("Logged in should not be called");
        }
        /** This identity will never log out. */
        public void notifyLoggedOut() {
            throw new AssertionError("Logged out should not be called");
        }
        /** {@inheritDoc} */
        public boolean equals(Object o) {
            if ((o == null) || (! (o instanceof DynamicIdentity)))
                return false;
            return this.name.equals(((DynamicIdentity)o).name);
        }
        /** {@inheritDoc} */
        public int hashCode() {
