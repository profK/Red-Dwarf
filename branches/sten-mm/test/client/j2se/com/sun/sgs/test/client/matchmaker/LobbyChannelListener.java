...
/**
 * The LobbyChannelListener signs up to receive the responses from a 
 * LobbyChannel's command requests.
 * 
 */
public interface LobbyChannelListener extends ChannelRoomListener {

    
    /**
     * Called in response to the LobbyChannel.requestGameParameters() command.
     * 
    ...
    /**
     * Called when a LobbyChannel.createGame request fails.
     * 
     ...
     */
    public void playerJoinedGame(String gameName, String player);
