...
/**
 * The GameChannel interface handles all communication with
 * a server side Game Room.  A client is given a GameChannel instance after 
 * successfully connecting to a game room.
 * 
 */
public interface GameChannel extends ChannelRoom {
