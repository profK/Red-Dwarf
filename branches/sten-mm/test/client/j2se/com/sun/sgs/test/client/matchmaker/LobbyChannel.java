...
/**
 * The LobbyChannel interface handles all communication with
 * a server side Lobby.  A client is given a LobbyChannel instance after 
 * successfully connecting to a lobby.
 */
public interface LobbyChannel extends ChannelRoom {
     ...
     * @param gameParameters	the map of game parameters 
