...
/**
 * This is the main interface that communicates with the server match making 
 * application.
 */
public interface MatchMakingClient {
     ...
     */
    public void joinLobby(String lobbyName, String password) throws IOException;
    ...
    /**
     * Attempts to leave the currently connected game room.  The client should 
     * not assume it has left the game room until it receives the 
     * MatchMakingClientListener.leftGame() callback.
     */
